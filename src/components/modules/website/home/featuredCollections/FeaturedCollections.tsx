          ...
          >
            <Box sx={{ position: 'relative', overflow: 'hidden' }}>
              <Image
                ...
                width={458}
                height={index === 0 || index === 5 ? 665 : 500} // Increase the height of the first and fourth image
              />

              {index === 0 || index === 5 ? ( // Conditional rendering for special collections
