                ...
                >
                  ...
                  >
                    <g clip-path="url(#clip0_152_9162)">
                      ...
                      />
                      <path
                        d="M12.4998 11.957C8.60413 11.957 5.43457 15.1266 5.43457 19.0223C5.43457 19.3223 5.67807 19.5657 5.97807 19.5657C6.27806 19.5657 6.52156 19.3222 6.52156 19.0222C6.52156 15.7255 9.20306 13.044 12.4998 13.044C15.7965 13.044 18.478 15.7255 18.478 19.0222C18.478 19.3222 18.7215 19.5657 19.0215 19.5657C19.3215 19.5657 19.565 19.3222 19.565 19.0222C19.565 15.1266 16.3955 11.957 12.4998 11.957Z"
                        fill="#05297F"
                      />
                      <path
                        d="M12.5002 3.26172C10.4024 3.26172 8.6958 4.96822 8.6958 7.06608C8.6958 9.16394 10.4023 10.8704 12.5002 10.8704C14.598 10.8704 16.3045 9.16389 16.3045 7.06608C16.3045 4.96827 14.598 3.26172 12.5002 3.26172ZM12.5002 9.78345C11.0024 9.78345 9.78279 8.56389 9.78279 7.06608C9.78279 5.56827 11.0024 4.34871 12.5002 4.34871C13.998 4.34871 15.2175 5.56827 15.2175 7.06608C15.2175 8.56389 13.998 9.78345 12.5002 9.78345Z"
                        fill="#05297F"
                      />
                    </g>
                    <defs>
                  ...
                  >
                    <g clip-path="url(#clip0_152_8510)">
                      <path
                        d="M23.5879 15.2902L25.4414 6.25117H7.17539L6.54063 3.24492L1.03594 0.558594L0.558594 1.5082L5.58594 3.93555L8.125 16.0621H22.8008C22.8008 16.0621 24.248 16.9711 23.6895 18.1187C23.4406 18.4742 23.0547 18.9109 22.3641 18.9109H7.75938V19.957H22.3691C23.3746 19.957 24.2227 19.4289 24.7 18.5859C25.6344 16.8391 23.5879 15.2902 23.5879 15.2902ZM9.02891 15.0008L7.38867 7.30234H24.1719L22.5824 15.0008H9.02891Z"
                        fill="black"
                      />
                      <path
                        d="M10.7761 21.4336C9.66396 21.4336 8.76514 22.3273 8.76514 23.4344C8.76514 24.5414 9.66396 25.4352 10.7761 25.4352C11.8882 25.4352 12.787 24.5414 12.787 23.4344C12.787 22.3273 11.8882 21.4336 10.7761 21.4336ZM10.7761 24.384C10.2479 24.384 9.82139 23.9625 9.82139 23.4344C9.82139 22.9062 10.2429 22.4848 10.7761 22.4848C11.3093 22.4848 11.7308 22.9062 11.7308 23.4344C11.7308 23.9625 11.3042 24.384 10.7761 24.384Z"
                        fill="black"
                      />
                      <path
                        d="M21.5769 21.4336C20.4647 21.4336 19.5659 22.3273 19.5659 23.4344C19.5659 24.5414 20.4647 25.4402 21.5769 25.4402C22.689 25.4402 23.6437 24.5465 23.5878 23.4395C23.5878 22.3324 22.689 21.4336 21.5769 21.4336ZM22.5315 23.4395C22.5315 23.9676 22.1101 24.3891 21.5769 24.3891C21.0437 24.3891 20.6222 23.9676 20.6222 23.4395C20.6222 22.9113 21.0437 22.4898 21.5769 22.4898C22.1101 22.4898 22.5823 22.9113 22.5315 23.4395Z"
                        fill="black"
                      />
                    </g>
                    <defs>
